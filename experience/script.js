...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Experience | Portfolio Nitheesh M B";
...
if (typeof ScrollReveal !== 'undefined') {
    ...
    reveal.reveal('.experience .timeline .container', { interval: 180 });
    reveal.reveal('.work-process .process-heading', { delay: 150 });
    reveal.reveal('.work-process .process-card', { interval: 140 });
}
